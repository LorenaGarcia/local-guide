        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 mb-12 h-[350px] md:h-[500px] lg:h-[600px]">
            ...
            >
                {(gallery?.[0] || image) ? (
                    ...
                    <span className="material-symbols-outlined text-6xl text-slate-300 relative z-10">image</span>
                )}
            </div>
            <div className="hidden lg:flex lg:col-span-4 flex-col gap-5 h-full">
                ...
                >
                    {(gallery?.[1] || image) ? (
                        ...
                        <span className="material-symbols-outlined text-4xl text-slate-300 relative z-10">image</span>
                    )}
                </div>
                <div
