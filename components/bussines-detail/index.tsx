  ...
  return (
    <div className="max-w-[1400px] mx-auto px-6 md:px-12 py-10 bg-white min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 mb-12">
        <div className="lg:col-span-8 relative rounded-[2rem] overflow-hidden group h-[350px] md:h-[500px] lg:h-[600px] cursor-pointer">
          <img
            src={gallery?.[0] || image}
        ...
        <div className="hidden lg:flex lg:col-span-4 flex-col gap-5">
          <div className="flex-1 relative rounded-[2rem] overflow-hidden h-1/2 cursor-pointer group">
            <img
              src={gallery?.[1] || image}
              className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000"
              alt="Gallery 1"
          ...
          <div className="flex-1 relative rounded-[2rem] overflow-hidden group cursor-pointer h-1/2">
            <img
              src={gallery?.[2] || image}
              className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000"
              alt="Gallery 2"
            ...
            {!!gallery?.length && (
              <div
                onClick={() => openGallery(gallery?.length || 0)}
        ...
        <div className="lg:col-span-8">
          ...
          <div className="flex flex-wrap gap-3 mb-16 pb-12 border-b border-slate-50">
            {COMPANYS_SOCIAL_MEDIA.map((social, i) => (
              <button
                key={i}
                className="flex items-center gap-3 pl-2 pr-6 py-2.5 rounded-full border border-slate-100 bg-white hover:bg-slate-50 transition-all group shrink-0"
              >
                <div
                ...
                >
                  <span
                    className={`material-symbols-outlined text-lg ${social.iconColor}`}
                  >
                    {social.icon}
                  </span>
                </div>
          ...
          <section className="mb-20">
            <div className="flex items-center justify-between mb-10">
              ...
              <button className="text-[#2D9C8D] font-bold text-[13px] hover:underline">
                Ver Horarios
              </button>
            </div>
        ...
        <div className="lg:col-span-4">
          <div className="sticky top-10 flex flex-col gap-6">
            <div className="bg-white p-10 rounded-[2.5rem] border border-slate-50 shadow-sm">
              ...
              <p className="text-center text-[11px] text-slate-300 font-medium mb-10 italic">
              ...
              <div className="space-y-5 mb-10">
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="text-[#1F4D47] font-black">
                    {hours?.weekdays}
                  </span>
                </div>
                <div className="flex justify-between items-center text-sm">
